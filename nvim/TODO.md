...
- [x] **Replace `none-ls.nvim` with `conform.nvim` + `nvim-lint`** — replaced none-ls with conform.nvim for formatting and nvim-lint for diagnostics. Dropped statix code actions.
