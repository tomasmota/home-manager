...
description: Generate and review Terraform code following HashiCorp's official style conventions and best practices. Use any time an agent needs to write Terraform code or review Terraform code.
---
...
Use this skill any time an agent needs to write Terraform code or review Terraform code.

- Generate new Terraform modules, resources, variables, outputs, providers, or locals
- Edit existing Terraform HCL while preserving HashiCorp style conventions
- Review Terraform code for style, naming, structure, validation, and security issues
- Check Terraform changes before proposing, committing, or merging them
